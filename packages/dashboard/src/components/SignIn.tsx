...
export function SignIn({
   ...
   * browser to `/auth/complete` on a dashboard origin, which trades the token for the bearer session
   * this client actually uses. The dashboard never sees the cookie.
   *
