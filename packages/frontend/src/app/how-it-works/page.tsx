    ...
    <section className="hiw">
      ...
      <div className="acts">
        <section className="act" aria-labelledby="act-what">
          ...
          <p>
            Any organization can be listed, and verified publishers manage their own listings
            directly. No one here decides who gets funded.
          </p>
        </section>
        <section className="act" aria-labelledby="act-build">
          <p className="act-eyebrow">If you&rsquo;re building</p>
          <h2 id="act-build">Search, read, leave</h2>
          <ol className="act-flow">
            <li>
              <strong>Search</strong>
              <small>by topic, org, city, type or award</small>
            </li>
            <li>
        ...
        <section className="act" id="publish" aria-labelledby="act-publish">
          ...
          <ol className="act-flow">
            <li>
              ...
              <small>creates your account the first time</small>
            </li>
            <li>
              <strong>
                <Link href="/listings/new">Submit a listing</Link>
              </strong>
              <small>reviewed against the public criteria</small>
            </li>
            <li className="is-exit">
              <strong>
                <Link href="/organizations">Get verified</Link>
              </strong>
              <small>then your account publishes instantly</small>
            </li>
          </ol>
          <p className="act-after">
            Already listed? <Link href="/directory">Open it in the directory</Link> and claim it.
          </p>
        </section>
      </div>
      ...
      <div className="rules">
        <p>
          <strong>Read the rules.</strong> The full spec: five roles and what each may do,
          namespaces, review criteria, governance and the export schema.
        </p>
        <nav className="rules-nav" aria-label="The rules">
          <a href="#rule-roles">Roles</a>
          <a href="#rule-matrix">Who can do what</a>
          <a href="#rule-words">Namespaces</a>
          <a href="#rule-verified">Verification</a>
          <a href="#rule-decisions">Governance</a>
          <a href="#rule-data">API &amp; export</a>
        </nav>
      </div>

      <details className="rule" id="rule-words">
        <summary>The words this site uses</summary>
        <h2 id="words" className="visually-hidden">
      ...
      <section className="rule rule-open" id="rule-roles">
        <h2 id="roles" className="rule-open-heading">
          The five roles
        </h2>
        <dl className="grid-2">
          <div>
      ...
      <details className="rule" id="rule-matrix">
        <summary>Who can do what</summary>
        <h2 id="matrix" className="visually-hidden">
          Who can do what
        </h2>
      ...
      <details className="rule" id="rule-verified">
        <summary>What "verified" means</summary>
        <h2 id="verified" className="visually-hidden">
          What &ldquo;verified&rdquo; means, and what it does not
        </h2>
        <p className="prose">
          Verification says a reviewer is satisfied that an organization&rsquo;s members speak for
          it. It is <strong>not</strong> an endorsement of the program, a check that its amounts are
        ...
        <p className="prose">
          ...
          No amount, deadline or eligibility rule here has been verified. Read the program&rsquo;s
          own page before you spend a week applying.
        </p>
      </details>
      <details className="rule" id="rule-why">
        <summary>Why it works this way</summary>
        <h2 id="why" className="visually-hidden">
        ...
        <details>
          ...
          <p className="prose">
            ...
            rejection needs a written reason, and both the reason and the handle of the member who
            wrote it go into the listing&rsquo;s history, which anybody can read. That is the whole
            safeguard, and it is deliberately the only one: an organization that can quietly bury an
            accurate listing about itself is a problem, and an organization that has to say why, in
            public, under a name, is not.
          </p>
        </details>
        <details>
          ...
          <p className="prose">
            ...
            used to widen a namespace&rsquo;s own reach, so they sit with people who have no stake
            in any of them. Reviewers are Hub staff rather than delegates precisely so that a
            reviewer decides on programs they compete with by the same rule as on programs they have
            never heard of.
          </p>
        </details>
        <details>
          ...
          <p className="muted prose">
            ...
            program in one sitting, and few enough that everything in the queue is something
            somebody meant.
          </p>
        </details>
      </details>
      <details className="rule" id="rule-data">
        <summary>The data is yours</summary>
        <h2 id="data" className="visually-hidden">
          The data is yours
        </h2>
        <p className="prose">
          Everything published here is available as bulk JSON and CSV exports and Atom and RSS
          feeds, under the same open standard the site itself uses — no scraping-required tier and
          no paid export.
        </p>
        <p className="row">
      ...
      <details className="rule" id="rule-decisions">
        ...
        <section aria-labelledby="decisions">
          <h2 id="decisions" className="visually-hidden">
