...
export interface SessionState {
   ...
   * "sign-in is broken", and a frontend that cannot tell them apart shows a spinner to somebody
  ...
  if (!result.ok) {
    return (
      <main className="shell-main">
        <h1>This frontend is not configured</h1>
        <p>
          This variable is read when the frontend is <strong>built</strong>, so setting it on the
        ...
        <p className="muted">
          <code>packages/frontend/README.md</code> lists it, and explains why the API origin is also
          written into the page&rsquo;s Content-Security-Policy.
        </p>
      </main>
    );
  }
