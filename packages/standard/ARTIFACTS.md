...
| [`schemas/v1.0.1/examples/`](./schemas/v1.0.1/examples) | 30 curated real-world documents. Illustrative, not normative. | 28 mapped from a public aggregator API; 2 security bug bounties transcribed from their publishers' own pages. See `BENCHMARK.md`. |
