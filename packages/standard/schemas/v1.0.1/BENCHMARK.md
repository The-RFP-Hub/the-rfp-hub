# RFP Hub Standard v1.0.1 — Real-Data Benchmark
...
- No fixture exercises `milestones[]`, `eligibility`, `serviceAgreement` or `prerequisites` —
  ...
  [conformance suite](../../conformance/v1.0.1), not by this benchmark.
...
> conformance suite — [`conformance/v1.0.1/pass/vc-fund.json`](../../conformance/v1.0.1/pass/vc-fund.json)
...
[`conformance/v1.0.1/`](../../conformance/v1.0.1). The single best all-round benchmark entry is
